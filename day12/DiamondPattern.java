...
{
public static void printLine(char ch1,int nhash,char ch2,int nstar,char ch3,int nhash)
{
for(int i=0;i<nhash;i++)System.out.print(ch1);
for(int i=0;i<nhash;i++)System.out.print(ch2);
for(int i=0;i<nhash;i++)System.out.print(ch3);
}
